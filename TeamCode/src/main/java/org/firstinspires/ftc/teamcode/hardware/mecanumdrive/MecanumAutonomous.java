...
public class MecanumAutonomous {
    //variables
    private MecanumDriveLibra driveTrain;
    ...
    //constructor
    public MecanumAutonomous(HardwareMap map, RobotPosition startingRobotPosition, double linearTolerance, 
                            double maxLinearDistance, double rotationalTolerance, double maxRotationalDistance) {


        driveTrain = new MecanumDriveLibra(map, "lmf", "rmf", "lmb", "rmb");
